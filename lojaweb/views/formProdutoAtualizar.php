...
<div class="col-md-2">
    ...
    <input type="text" class="form-control" name="pId" value= <? $produto->getId()?> readonly>
  </div>  
<div class="col-md-3">
    <label for="pReferencia" class="form-label">Nº Referencia</label>
    <input type="text" class="form-control" name="pReferencia" value=<? $produto->getRef()?> readonly>
  </div>
  <div class="col-md-7">
  ...
  <div class="col-md-3">
    ...
    <input type="date" class="form-control" name="pDataFabricacao" value=<? date("Y-m-d",$produto->getDtFabricacao())?>>
  </div>
  <div class="col-md-4">
